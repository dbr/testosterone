...
# The PyTest package on which pytest is built provides a utility class that has
# a convenience method called 'catch_exc' for this. This is currently the only
