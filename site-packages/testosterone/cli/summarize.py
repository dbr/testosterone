...
def summarize(base, quiet=True, recursive=True, run=True, stopwords=()):
    """Given a dotted module name, return a summary report on it's tests.
    ...
    for module in modules:
        ...
        if yes:
            print >> report, name, pass5, fail, err, all
    ...
    print >> report, BORDER
    print >> report, "TOTAL".ljust(60), tpass5, tfail, terr, tall
