...
from testosterone.interactive.utils import ColorBucket
...
class CursesInterface:
    ...
    def wrapme(self, win):
        ...
        self.colors = ColorBucket()
        self.colors.WHITE = curses.color_pair(1)|curses.A_BOLD
        self.colors.RED_DARK = curses.color_pair(2)|curses.A_DIM
        self.colors.RED = curses.color_pair(2)|curses.A_BOLD
        self.colors.GREEN_DARK = curses.color_pair(3)|curses.A_DIM
