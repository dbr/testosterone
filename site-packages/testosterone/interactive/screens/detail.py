...
class DetailScreen(BaseScreen):
    ...
    results = None  # the right ScrollArea
    ...
    def refresh(self, base, run=False):
        ...
        """
        try:
            self.detail.refresh(base, run)
        except RefreshError:
            self.traceback = self.detail.traceback
            return False
        except:
    ...
    def draw(self):
        ...
        self.tests = self.pane('tests')
        self.result = self.pane('result')
        self.draw_list()
