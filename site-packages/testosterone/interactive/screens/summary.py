...
class SummaryScreen(BaseScreen):
    ...
    UI-driven events:
        ...
        enter -- run selection and go to results screen
    ...
    def react(self, c):
        ...
        # ====================
            ...
            self.run()
        elif c in (ascii.LF, curses.KEY_ENTER, curses.KEY_RIGHT): # enter/right
            # Show a DetailScreen if there are tests and not all pass.
            if self.selected:
                if self.summary.data[self.selected][3] == '0':
                    curses.beep()
                    return
    ...
    def populate(self):
        ...
        if self.listing is not None:
            if (   (self.listing.numrows == numrows)
               and (self.listing.numitems == numitems)
               and (self.listing.toprow == toprows)
                  ):
                return

        self.listing = ScrollArea(numrows, numitems, self.toprows)
