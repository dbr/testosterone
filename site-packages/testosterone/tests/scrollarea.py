...
class TwoAndAHalfPageListing(unittest.TestCase):
    ...
    def testPageDownFromSecondRow(self):
        self.area.scroll(19)
        self.area.page_down()
        self.area.page_down()
        expected = (20, 0, 50, 20, 40, 20)
